    ...
    return(
        <div style={{width:'100%'}}>
            ...
            <div className={classes.content} style={{width:"100%", marginTop:'8%', marginBottom:'5%'}}>
                ...
                <div>
                            <TextField id="standard-basic" label="Search Through Pre-Bookings" style={{marginTop:"1%", marginBottom:'2%', marginRight:'20%',width:'60%',color:"white"}} />
                            ...
                            </div>
                {
                    menu.length == 0 ? (
                        ...
                        menu.map((res)=> (
                            <>
                            <Card className={classes.displayCard} style={{width:"72%",height:125}}>
                            ...
                            <div>
                                    ...
                                    <Button  className={classes.but} color="inherit" style={{marginTop:"-160px",marginRight:'-50%',width:'10%'}} onClick={(e) => { deleteMenu(res.id) }}>Cancel</Button>
